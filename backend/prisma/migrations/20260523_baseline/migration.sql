...
CREATE TABLE "Workspace" (
    ...
    "aiPrompt" TEXT NOT NULL DEFAULT 'You are a helpful customer support assistant for a digital marketing business. Keep your replies concise and focus on guiding users toward our products.',
